...
/// Redis pub/sub for ws-gateway `position_update` (same JSON as `fill_action == "created"`).
async fn publish_open_position_to_redis_ws(
                                    ...
                                    if let Some(pos_id) = position_id {
                                        if fill_action == "created" {
                                            ...
                                            let side_str = match pos_event.side {
                                                contracts::enums::PositionSide::Long => "LONG",
                                                contracts::enums::PositionSide::Short => "SHORT",
                                            };
                                            publish_open_position_to_redis_ws(
                                                &mut conn,
                                                pos_event.user_id,
