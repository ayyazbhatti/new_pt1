...
export const ALL_PERMISSION_KEYS: readonly string[] = [
  ...
  'symbols:view', 'symbols:create', 'symbols:edit', 'symbols:delete', 'markup:view', 'markup:create', 'markup:edit', 'markup:delete', 'swap:view', 'swap:create', 'swap:edit', 'swap:delete', 'fees:view', 'fees:edit',
...
export const ADMIN_PAGE_PERMISSIONS: Record<string, string[]> = {
  ...
  '/admin/fees': ['fees:view', 'fees:edit'],
  '/admin/sessions': ['sessions:view', 'sessions:edit'],
  ...
  '/admin/kyc': ['kyc:view', 'kyc:approve'],
}
