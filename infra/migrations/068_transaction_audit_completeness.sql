-- Phase 2: strict wallet audit — new transaction_type values for cash margin + affiliate commission.
-- Ledger mirror rows use type `affiliate_commission` (replacing `rebate` for referral payouts).
